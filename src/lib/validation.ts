...
export const productSchema = z.object({
  ...
  category: z.string().min(1, "Category is required"), // Dynamic category from database
  ...
  // Images can be either string array (simple) or object array (with publicId)
  images: z
    .union([
      z
        .array(z.string().url("Image must be a valid URL"))
        .max(5, "Maximum 5 images allowed"), // Simple string array
      z
        .array(
          z.object({
...
export const categorySchema = z.object({
  ...
  image: z.string().url("Image must be a valid URL").optional(), // Optional image URL
