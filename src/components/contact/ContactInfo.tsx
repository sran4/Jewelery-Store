        ...
        <div className="flex gap-4">
          {siteSettings.socialMedia.facebook && (
            <a
              ...
              className="w-12 h-12 flex items-center justify-center bg-primary/10 hover:bg-primary hover:text-primary-foreground rounded-full transition-colors"
              aria-label="Facebook"
            >
